...
const signatureMap = {
  "NUR_A": "Images/nura.png",
  "NUR_B": "Images/nurb.png",
  "LKG_A": "Images/lkga.png",
  "LKG_B": "Images/lkgb.png",
  "UKG_A": "Images/ukga.png",
  "UKG_B": "Images/ukgb.png",
  "I (A)": "Images/ia.png",
  "I (B)": "Images/ib.png",
  "II (Two)": "Images/iia.png",
  "III (Three)": "Images/iiia.png",
  "IV (Four)": "Images/iva.png",
  "V (Five)": "Images/va.png",
  "VI (Six)": "Images/via.png",
  "VII (Seven)": "Images/viia.png",
  "VIII (Eight)": "Images/viiia.png",
  "IX (Nine)": "Images/jagatinfras.png",
  "X (Ten)": "Images/jagatinfras.png"
};
...
function getFmBreakdown(fm, writtenVal, studentClass, subject) {
  ...
  if (fm === 50) {
    ...
    const specialClasses = ['UKG_A', 'UKG_B', 'I (A)', 'I (B)'];
    const isHindi = (subject === 'HN' || subject === 'HINDI');
    
    if (specialClasses.includes(String(studentClass)) && isHindi) {
...
function downloadPDF() {
  ...
  const className = document.getElementById('studentClass').innerText || 'Class';

  const opt = {
    margin: 0,
    filename: `Marksheet_${className}_${studentName}.pdf`,
